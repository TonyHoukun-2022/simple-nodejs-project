...
//when nodejs start reading file in the background at code readFile(), it will not block the code, so the next line of code "log reading file" will be executed. after that, and after the file has 
been read, then log the data
